...
# hxltmcli _data/tm/vaccinum.tm.hxl.csv --objectivum-formulam schemam/XZ/vaccinum/vaccinum-testum.🗣️.json --objectivum-linguam por-Latn --agendum-linguam eng-Latn,lat-Latn
